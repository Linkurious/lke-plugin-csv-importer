...
1. Download the `lke-plugin-csv-importer-1.0.1.lke` plugin available [here](https://github.com/Linkurious/lke-plugin-csv-importer/releases/tag/v1.0.1).
2. Copy `lke-plugin-csv-importer-1.0.1.lke` file to the following path `<linkurious>/data/plugins`
